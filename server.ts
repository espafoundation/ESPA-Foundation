...
async function processApplicationStatusChange(req: any, res: any) {
  ...
  if (applicantEmail && (normalizedStatus === 'Approved' || normalizedStatus === 'Rejected')) {
    ...
    const html = isApproved
      ? `<!DOCTYPE html><html><body><p>Dear ${applicantName},</p><p>Your application to volunteer with ESPA Foundation has been approved.</p><p>You can now access the Portal on <a href="https://library.espafoundation.social/portal">ESPA Digital Library</a> using the following credentials:</p><p>Email: ${applicantEmail}<br>Password: ${applicantPassword}<br>Portal: <a href="https://library.espafoundation.social/portal">https://library.espafoundation.social/portal</a></p><p>Please keep your login credentials secure and do not share your password with anyone.</p><p>Further information regarding your volunteer role and responsibilities will be available through the ESPA Digital Library.</p><p>Welcome to ESPA Foundation. We look forward to having you contribute to our mission.</p><p>ESPA Foundation<br>From Exclusion to Education</p></body></html>`
      : undefined;
